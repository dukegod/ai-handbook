---
title: AI 工具
description: AI 工具横评——CLI / IDE / 插件 / 框架 / 多平台 Agent 5 种形态、8 大工具的选型决策
...
> 选工具、看评测、形成选型决策——覆盖 CLI / IDE / 插件 / 框架 / 多平台 Agent 5 种形态。
...
```mermaid
flowchart LR
  A[工具横评<br/>Claude Code / Cursor / OpenClaw]
...
**工具横评** — Claude Code / Cursor / GitHub Copilot / Codex CLI / Trae / PI-agent / DeepSeek Harness / OpenClaw 的深度对比
...
| 场景 | 从这里开始 |
|------|-----------|
| 还没选工具 | [AI 工具全景](/ai-coding/tools/overview) |
