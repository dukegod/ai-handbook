      ...
      '/claude-code/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Read 读文件', link: '/claude-code/tools/read' },
            { text: 'Edit / Write 改文件', link: '/claude-code/tools/edit-and-write' },
            { text: 'Bash 执行命令', link: '/claude-code/tools/shell' },
            { text: 'Grep / Glob 搜索', link: '/claude-code/tools/search' },
            { text: 'WebFetch / WebSearch', link: '/claude-code/tools/web' },
            { text: 'TodoWrite 任务列表', link: '/claude-code/tools/todo' },
            { text: 'Task 派生子代理', link: '/claude-code/tools/dispatch-subagent' },
            { text: 'Notebook 编辑', link: '/claude-code/tools/notebook' },
          ],
        },
        {
          text: '定制化',
      ...
      '/ai-core/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '预训练与微调', link: '/ai-core/fundamentals/pretraining' },
            { text: 'RLHF 与对齐', link: '/ai-core/fundamentals/alignment' },
          ],
        },
        {
          text: '模型架构',
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '数据工程', link: '/ai-core/training/data-engineering' },
            { text: '推理优化', link: '/ai-core/training/inference-optimization' },
            { text: '量化与蒸馏', link: '/ai-core/training/quantization' },
          ],
        },
        {
          text: '评估方法',
          collapsed: true,
          items: [
            { text: '基准测试', link: '/ai-core/eval/benchmarks' },
            { text: '评估方法论', link: '/ai-core/eval/methodology' },
          ],
        },
      ],
      ...
      '/ai-trends/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'xAI · Grok 全系', link: '/ai-trends/vendors/grok/' },
          ],
        },
        {
          text: '国内厂商',
          ...
          items: [
            ...
            { text: 'Moonshot · Kimi 全系', link: '/ai-trends/cn-vendors/moonshot/' },
            { text: 'MiniMax 全系', link: '/ai-trends/cn-vendors/minimax/' },
            { text: 'Zhipu · 智谱 GLM 全系', link: '/ai-trends/cn-vendors/zhipu/' },
            { text: 'Qwen · 阿里通义千问全系', link: '/ai-trends/cn-vendors/qwen/' },
          ],
        },
        {
          text: '技术速递',
          collapsed: true,
          items: [
            { text: '重要论文速递', link: '/ai-trends/research-highlights/papers' },
            { text: '开源项目推荐', link: '/ai-trends/research-highlights/open-source' },
          ],
        },
        {
          text: '行业观察',
          collapsed: true,
          items: [
            { text: '行业趋势', link: '/ai-trends/industry/trends' },
            { text: '投融资动态', link: '/ai-trends/industry/funding' },
          ],
        },
      ],
